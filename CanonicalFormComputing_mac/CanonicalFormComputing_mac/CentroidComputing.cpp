...
{
	int n = searchEdge(index);
	vertices dupV = { (int)(endpointList.size())+1000001,&edgeList_tree[n] ,edgeList_tree[n].target_v };
...
{
	mkdir("tree_result_inPsudoVer",0755);
...
int PlaneGraph::APTEDformTrans_MutiRoot()
{
	...
	mkdir(("./" + folderPath + "/" + this->graphName).c_str(),0755);
